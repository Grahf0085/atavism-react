    ...
    <section className={styles.connecting}>
      ...
      <section className={styles.meat}>
        ...
        <ol className={connectingStyles.connectingSection}>
          ...
          <li className={connectingStyles.connectingLi}>Download Installer <a href="https://drive.google.com/file/d/16vexrb3u_RewtnhEPo-BFA4pnmH8QGcY/view?usp=sharing">-&gt;Here&lt;-</a></li>
        ...
        <h2>Windows</h2>
        <ul className={connectingStyles.connectingSection}>
          <li className={connectingStyles.connectingLi}>Download Installer <a href="https://drive.google.com/file/d/16vexrb3u_RewtnhEPo-BFA4pnmH8QGcY/view?usp=sharing">-&gt;Here&lt;- and unzip</a></li>
          <li className={connectingStyles.connectingLi}>Extract contents of archive</li>
