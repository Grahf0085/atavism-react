        ...
        <ul className={infoStyles.whatFind}>
          ...
          <li className={infoStyles.items}>
            <ol className={infoStyles.changedPart}>
              ...
              <li className={infoStyles.items}>Several abilities/traits implemented from the start. Ie MNK and NIN have suble blow and DRG has spirit surge even though those were not vanilla traits/abilities</li>
          ...
          <li className={infoStyles.items}>
            <ol className={infoStyles.changedPart}>
              <li className={infoStyles.items}>Max Level: 50. No ROZ until Shadow Lord falls. No COP until sky access</li>
